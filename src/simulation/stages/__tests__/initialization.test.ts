...
function createMockDataLoadingResult(
  overrides: Partial<DataLoadingResult> = {}
): DataLoadingResult {
...
function createMockResamplingResult(
  overrides: Partial<ResamplingResult> = {}
): ResamplingResult {
...
function createMockIndicatorInfoMap(
  entries: [string, Partial<IndicatorInfo>][]
...
function createMockInitializationResult(
  overrides: Partial<InitializationResult> = {}
...
describe("getIndicatorKeys", () => {
  ...
  it("returns keys in insertion order", () => {
    const map = new Map<string, IndicatorInfo>();
    map.set("first", { indicatorKey: "first", indicatorType: "RSI", conditionType: "LONG_ENTRY", isRequired: true });
    map.set("second", { indicatorKey: "second", indicatorType: "EMA", conditionType: "LONG_EXIT", isRequired: false });
