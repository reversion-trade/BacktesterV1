...
import type { IExecutor, OrderRequest, OrderResult, OpenOrder, Position } from "../../interfaces/executor.ts";
...
export class FakeExecutor implements IExecutor {
    ...
    async placeOrder(order: OrderRequest): Promise<OrderResult> {
        ...
        const slippageMultiplier =
            order.side === "BUY" ? 1 + this.config.slippageBps / 10000 : 1 - this.config.slippageBps / 10000;
