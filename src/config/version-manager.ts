...
export class VersionManager {
     ...
     */
    renameConfig(existingConfig: VersionedAlgoConfig, newName: string, changeNotes?: string): VersionedAlgoConfig {
        const now = Math.floor(Date.now() / 1000);
        const newVersion = existingConfig.version + 1;
     ...
     */
    cloneConfig(sourceConfig: VersionedAlgoConfig, newUserID: string, newAlgoName: string): VersionedAlgoConfig {
