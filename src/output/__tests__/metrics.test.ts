...
describe("Sortino Ratio calculation", () => {
  ...
  it("only penalizes downside deviation", () => {
    ...
    const equityCurveUpside = createDailyEquityCurve([
      10000, 10200, 10150, 10400, 10350, 10600, 10550
    ]);
    ...
    const equityCurveDownside = createDailyEquityCurve([
      10000, 9800, 10100, 9900, 10200, 10100, 10550
    ]);
...
describe("Edge Cases", () => {
  ...
  it("handles very small numbers", () => {
    const trades = [
      createTradeRecord({ pnlUSD: 0.0001 }),
      createTradeRecord({ pnlUSD: -0.00005 }),
    ];
  ...
  it("handles very large numbers", () => {
    const trades = [
      createTradeRecord({ pnlUSD: 1000000000 }),
      createTradeRecord({ pnlUSD: -500000000 }),
    ];
