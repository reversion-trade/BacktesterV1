...
import type { BacktestOutput, SwapMetrics, AlgoMetrics } from "../../../src/events/types.ts";
import type { IndicatorCalculationResult } from "../../../src/simulation/stages/indicator-calculation.ts";
import type { ResamplingResult, ResampledSignalCache } from "../../../src/simulation/stages/resampling.ts";
import type { InitializationResult } from "../../../src/simulation/stages/initialization.ts";
import type { MipMapBuildingResult } from "../../../src/simulation/stages/mipmap-building.ts";
import type { SubBarLoadingResult } from "../../../src/simulation/stages/subbar-loading.ts";
import type { ValueFactorLoadingResult } from "../../../src/simulation/stages/valuefactor-loading.ts";
import type { ConditionType } from "../../../src/events/types.ts";
import type { IndicatorInfo } from "../../../src/events/collector.ts";
import type { Candle } from "../../../src/core/types.ts";
import type { SignalCache } from "../../../src/indicators/calculator.ts";
import { MIN_SIMULATION_RESOLUTION } from "../../../src/indicators/resampler.ts";
import { getExpectedSubBarCount } from "../../../src/simulation/stages/subbar-loading.ts";
