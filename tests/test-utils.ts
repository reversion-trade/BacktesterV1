...
import type { SwapEvent, TradeEvent, AlgoEvent, ConditionSnapshot, SwapMetrics } from "../src/events/types.ts";
 ...
 */
export function createMockCandles(count: number, options: MockCandleOptions = {}): Candle[] {
    const {
        startPrice = 10000,
        volatility = 0.02,
        trend = 0,
 ...
 */
export function createUptrendCandles(count: number, startPrice: number = 10000): Candle[] {
 ...
 */
export function createDowntrendCandles(count: number, startPrice: number = 10000): Candle[] {
    return createMockCandles(count, { startPrice, trend: -1, volatility: 0.01 });
}
 ...
 */
export function createSidewaysCandles(count: number, startPrice: number = 10000): Candle[] {
 ...
 */
export function createMockValueConfig(overrides: Partial<ValueConfig> = {}): ValueConfig {
    return {
        type: "REL",
        value: 0.1, // 10%
        ...overrides,
 ...
 */
export function createMockAlgoParams(overrides: Partial<AlgoParams> = {}): AlgoParams {
    return {
        type: "LONG",
 ...
 */
export function createMockAlgoConfig(overrides: Partial<AlgoConfig> = {}): AlgoConfig {
    return {
        userID: "test-user",
        algoID: "test-algo",
 ...
 */
export function createMockSwapEvent(overrides: Partial<SwapEvent> = {}): SwapEvent {
    return {
 ...
 */
export function createEntrySwap(price: number, amountUSD: number, barIndex: number, asset: string = "BTC"): SwapEvent {
 ...
 */
export function createExitSwap(price: number, amountAsset: number, barIndex: number, asset: string = "BTC"): SwapEvent {
 ...
 */
export function createMockTradeEvent(overrides: Partial<TradeEvent> = {}): TradeEvent {
 ...
 */
export function createMockConditionSnapshot(overrides: Partial<ConditionSnapshot> = {}): ConditionSnapshot {
    return {
        requiredTrue: 1,
        requiredTotal: 2,
        optionalTrue: 0,
 ...
 */
export function createMockSignalCache(indicators: Record<string, boolean[]>): Map<string, boolean[]> {
 ...
 */
export function createAllTrueSignalCache(indicatorKey: string, length: number): Map<string, boolean[]> {
 ...
 */
export function createAllFalseSignalCache(indicatorKey: string, length: number): Map<string, boolean[]> {
 ...
 */
export function assertApproxEqual(actual: number, expected: number, tolerance: number = 0.0001): void {
